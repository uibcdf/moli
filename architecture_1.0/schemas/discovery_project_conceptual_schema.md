...
discovery_project:
  ...
  external_knowledge:
    - id: string
      source_ref: versioned-or-snapshotted-ref  # e.g. Sabueso resolved knowledge or SourceAssertion
      used_by: [ref]
...
If future use cases require durable assertions that are neither observations, evidence, nor hypotheses, `Claim` can be introduced later without changing the corrected top-level platform architecture.
